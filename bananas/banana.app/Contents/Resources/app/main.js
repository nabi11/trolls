...
var shortcuts = ['F13', 'CommandOrControl+A', 'CommandOrControl+Left', 'CommandOrControl+Right',
'CommandOrControl+Up', 'CommandOrControl+Down', 'Alt+VolumeUp'];
...
function makeWins() {
	...
	shortcuts.forEach(function(value) {
		const ret = globalShortcut.register(value, short);
	});
